...
export default async function Page() {
  ...
  const page = await client.getSingle("skate_page").catch(() => notFound());
...
function bundleTextAndImageSlices(slices:Content.SkatePageDocumentDataSlicesSlice[]){
  const res : (
    Content.SkatePageDocumentDataSlicesSlice
